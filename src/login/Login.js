    ...
    return (
      <div className="App">
        ...
        <div className='form' align='center'>
          {/* <form> */}
            <span>账号:&nbsp;</span><input style={{height: '30px', width: '200px'}} type='text' name='账号' /><br/>
            <span>密码:&nbsp;</span><input style={{height: '30px', width: '200px', marginTop: '20px'}} type='password' name='密码' />
